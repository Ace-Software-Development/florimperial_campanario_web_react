    ...
    <div className="App">
      ...
      <Container>
        <Row xs={12} s={12} md={12} className="g-4">
          ...
          <Card className="text-center position-relative" style={{width:"55%", background: '#ebebeb'}}>
             ...
             <Card.Body>
              ...
              <br/>
              <Button variant="primary" type="submit" form="recoverPassword" className="btn-publicar btn-recovery"  > Recuperar contraseña </Button>
              <br/><br/>
              <a className="recuperar-contrasena" href="/"> Regresar a Login</a>
            </Card.Body>
